...
//   List<String> labels;
//
//   ClassificationService({File modelPath, String labelPath}) {
...
//   }
//
//   Future<void> loadModel(File model) async {
//     try {
//       interpreter = Interpreter.fromFile(model, options: _interpreterOptions);
//
